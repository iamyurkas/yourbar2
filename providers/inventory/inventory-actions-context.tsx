...
export type InventoryActionsContextValue = {
  ...
  toggleCocktailParty: (id: number) => void;
  addCocktailIngredientsToShopping: (cocktail: Cocktail) => void;
  addCocktailsIngredientsToShopping: (cocktails: Cocktail[]) => void;
  ...
  setOnboardingStarterApplied: (value: boolean) => void;
