...
declare global {
  ...
  // eslint-disable-next-line no-var
  var __yourbarInventoryUseCardView: boolean | undefined;
  // eslint-disable-next-line no-var
...
export function readInventoryRuntimeCache(): InventoryRuntimeCache {
  return {
    ...
    useCardView: globalThis.__yourbarInventoryUseCardView,
...
export function writeInventoryRuntimeCache(cache: InventoryRuntimeCache): void {
  ...
  globalThis.__yourbarInventoryUseCardView = cache.useCardView;
