...
export type InventoryRuntimeCache = {
  ...
  showCardsInCollections: boolean | undefined;
...
declare global {
  ...
  // eslint-disable-next-line no-var
  var __yourbarInventoryShowCardsInCollections: boolean | undefined;
  // eslint-disable-next-line no-var
...
export function readInventoryRuntimeCache(): InventoryRuntimeCache {
  return {
    ...
    showCardsInCollections: globalThis.__yourbarInventoryShowCardsInCollections,
...
export function writeInventoryRuntimeCache(cache: InventoryRuntimeCache): void {
  ...
  globalThis.__yourbarInventoryShowCardsInCollections = cache.showCardsInCollections;
