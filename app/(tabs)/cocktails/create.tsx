...
export default function CreateCocktailScreen() {
  ...
  const placeholderLabel = useMemo(
    () => (imageUri ? t("cocktailForm.changePhoto") : t("cocktailForm.addPhotoTitle")),
    [imageUri],
  );
  ...
  const ensureMediaPermission = useCallback(async () => {
    ...
    if (!canAskAgain) {
      showDialog({
        title: t("cocktailForm.mediaAccessRequiredTitle"),
        message:
  ...
  const handlePickImage = useCallback(async () => {
    ...
    try {
      ...
      showDialog({
        title: t("cocktailForm.couldNotPickImageTitle"),
  ...
  const ensureCameraPermission = useCallback(async () => {
    ...
    if (!canAskAgain) {
      showDialog({
        title: t("cocktailForm.cameraAccessRequiredTitle"),
        message:
  ...
  const handleTakePhoto = useCallback(async () => {
    ...
    try {
      ...
      showDialog({
        title: t("cocktailForm.couldNotTakePhotoTitle"),
        message: t("common.tryAgainLater"),
        actions: [{ label: t("common.ok") }],
      });
    } finally {
  ...
  const handleSelectImageSource = useCallback(() => {
    showDialog({
      title: t("cocktailForm.addPhotoTitle"),
  ...
  const handleSubmit = useCallback(async () => {
    ...
    if (!trimmedName) {
      showDialog({
        title: t("cocktailForm.nameRequiredTitle"),
    ...
    if (!sanitizedIngredients.length) {
      showDialog({
        title: t("cocktailForm.recipeRequiredTitle"),
    ...
    try {
      ...
      if (!persisted) {
        showDialog({
          title: t("cocktailForm.couldNotSaveTitle"),
          message: t("common.tryAgainLater"),
          actions: [{ label: t("common.ok") }],
        });
        return;
  ...
  const handleDeletePress = useCallback(() => {
    ...
    if (numericId == null) {
      showDialog({
        title: t("cocktailForm.cocktailNotFoundTitle"),
        message: t("common.tryAgainLater"),
        actions: [{ label: t("common.ok") }],
      });
      return;
    ...
    const message = trimmedName
      ...
      : t("cocktailForm.deleteCocktailConfirm");

    showDialog({
      title: t("cocktailForm.deleteCocktailTitle"),
      message,
      actions: [
        { label: t("common.cancel"), variant: "secondary" },
        {
          ...
          onPress: () => {
            ...
            if (!wasDeleted) {
              showDialog({
                title: t("cocktailForm.couldNotDeleteTitle"),
                message: t("common.tryAgainLater"),
                actions: [{ label: t("common.ok") }],
              });
              return;
  ...
  const confirmLeave = useCallback(
    (onLeave: () => void) => {
      showDialog({
        title: t("common.leaveWithoutSavingTitle"),
        message: t("common.leaveWithoutSavingMessage"),
        actions: [
          { label: t("common.save"), variant: "primary", onPress: handleSubmit },
          { label: t("common.stay"), variant: "secondary" },
          {
        ...
        >
          <View style={styles.section}>
            ...
            <TextInput
              ...
              placeholder={t("cocktailForm.placeholderName")}
              style={[
                styles.input,
                {
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              placeholder={t("cocktailForm.placeholderDescription")}
              placeholderTextColor={`${Colors.onSurfaceVariant}99`}
              style={[
                styles.input,
          ...
          <View style={styles.section}>
            ...
            <TextInput
              ...
              placeholder={t("cocktailForm.placeholderInstructions")}
              placeholderTextColor={`${Colors.onSurfaceVariant}99`}
              style={[
                styles.input,
                styles.multilineInput,
    ...
    >
      ...
      <View style={styles.ingredientNameWrapper}>
        <TextInput
          ...
          placeholder={t("cocktailForm.placeholderIngredientName")}
          placeholderTextColor={`${Colors.onSurfaceVariant}99`}
          style={[
            styles.input,
      ...
      <View style={styles.rowInputs}>
        <View style={styles.amountColumn}>
          ...
          <TextInput
            ...
            placeholder={t("cocktailForm.placeholderAmount")}
            placeholderTextColor={`${Colors.onSurfaceVariant}99`}
      ...
      {isBrandedIngredient ? (
        <View style={styles.toggleRow}>
          <ToggleChip
            ...
            onInfo={() =>
              onOpenDialog({
                title: t("cocktailForm.allowBaseSubstituteTitle"),
                message:
                  t("cocktailForm.allowBaseSubstituteMessage"),
                actions: [{ label: t("common.ok") }],
              })
            }
          />
          <ToggleChip
            ...
            onInfo={() =>
              onOpenDialog({
                title: t("cocktailForm.allowBrandedSubstituteTitle"),
                message:
                  t("cocktailForm.allowBrandedSubstituteMessage"),
                actions: [{ label: t("common.ok") }],
              })
            }
          />
      ...
      {shouldShowStyleSubstitution ? (
        <View style={styles.toggleRow}>
          <ToggleChip
            ...
            onInfo={() =>
              onOpenDialog({
                title: t("cocktailForm.allowStyleSubstitutesTitle"),
                message:
                  t("cocktailForm.allowStyleSubstitutesMessage"),
                actions: [{ label: t("common.ok") }],
              })
            }
          />
          ...
          <View style={styles.substitutesList}>
            {ingredient.substitutes.map((substitute) => (
              ...
              >
                ...
                >
                  {substitute.name}
                  {substitute.isBrand ? t("cocktailForm.brandSuffix") : ""}
                </Text>
                <Pressable
                  onPress={() =>
