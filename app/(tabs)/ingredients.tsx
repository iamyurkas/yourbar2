...
export default function IngredientsScreen() {
  ...
  const availableTagOptions = useMemo<IngredientTagOption[]>(() => {
    ...
    return Array.from(map.values()).sort((a, b) => {
      const aOrder = BUILTIN_TAG_ORDER.get(a.key) ?? BUILTIN_TAG_ORDER.get(a.name.toLowerCase());
      const bOrder = BUILTIN_TAG_ORDER.get(b.key) ?? BUILTIN_TAG_ORDER.get(b.name.toLowerCase());
