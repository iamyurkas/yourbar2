...
const glassImages: Record<string, ImageSourcePropType> = {
...
export const GLASSWARE: GlasswareOption[] = [
  ...
  { id: 'champagne_flute', name: 'Champagne Flute', image: glassImages.champagne_flute },
  { id: 'cocktail_glass', name: 'Cocktail glass', image: glassImages.cocktail_glass },
  { id: 'collins_glass', name: 'Collins glass', image: glassImages.collins_glass },
  ...
  { id: 'highball_glass', name: 'Highball glass', image: glassImages.highball_glass },
  { id: 'hurricane_glass', name: 'Hurricane glass', image: glassImages.hurricane_glass },
  { id: 'irish_coffee_glass', name: 'Irish Coffee glass', image: glassImages.irish_coffee_glass },
  { id: 'margarita_glass', name: 'Margarita glass', image: glassImages.margarita_glass },
  { id: 'nick_and_nora', name: 'Nick and Nora', image: glassImages.nick_and_nora },
