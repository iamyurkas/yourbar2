...
export const BUILTIN_INGREDIENT_TAGS = [
  ...
  { id: 4, name: "Bitters", color: TAG_COLORS[13] },
  { id: 5, name: "Syrup", color: TAG_COLORS[10] },
  { id: 6, name: "Fruit/Veg & Juice", color: TAG_COLORS[9] },
  { id: 7, name: "Mixer", color: TAG_COLORS[8] },
  { id: 8, name: "Fridge/Pantry", color: TAG_COLORS[14] },
