...
export interface InventoryStorageAdapter {
  loadInventorySnapshot<TCocktail, TIngredient>(): Promise<InventorySnapshot<TCocktail, TIngredient> | undefined>;
  persistInventorySnapshot<TCocktail, TIngredient>(snapshot: InventorySnapshot<TCocktail, TIngredient>): Promise<void>;
  loadCocktailTagDeltaSnapshot(): Promise<CocktailTagDeltaSnapshot>;
  persistCocktailTagDeltaSnapshot(snapshot: CocktailTagDeltaSnapshot): Promise<void>;
