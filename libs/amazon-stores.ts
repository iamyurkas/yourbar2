...
export const AMAZON_STORES: Record<AmazonStoreKey, AmazonStoreConfig> = {
  US: {
    ...
    affiliateTag: "yourbarfree-20",
  },
  UK: {
    domain: "amazon.co.uk",
    label: "Amazon.co.uk",
    countryName: "United Kingdom",
    affiliateTag: "yourbarfree04-21",
  },
  DE: {
    domain: "amazon.de",
    label: "Amazon.de",
    countryName: "Germany",
    affiliateTag: "yourbarfree05-21",
  },
  FR: {
    domain: "amazon.fr",
    label: "Amazon.fr",
    countryName: "France",
    affiliateTag: "yourbarfree0b-21",
  },
  IT: {
    domain: "amazon.it",
    label: "Amazon.it",
    countryName: "Italy",
    affiliateTag: "yourbarfree02-21",
  },
  ES: {
    domain: "amazon.es",
    label: "Amazon.es",
    countryName: "Spain",
    affiliateTag: "yourbarfree0c-21",
  },
  NL: {
    domain: "amazon.nl",
    label: "Amazon.nl",
...
export function detectAmazonStoreFromLocale(): AmazonStoreKey | null {
  return mapCountryToAmazonStore(
    getLocaleCountryCode(),
    LOCALE_COUNTRY_TO_AMAZON_STORE,
  );
}

export function detectAmazonStoreFromStoreOrLocale(): AmazonStoreKey | null {
  const storefrontStore = mapCountryToAmazonStore(
    getStorefrontCountryCode(),
    STOREFRONT_COUNTRY_TO_AMAZON_STORE,
  );
  if (storefrontStore) {
