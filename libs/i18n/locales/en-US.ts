...
export const enUSTranslations: TranslationDictionary = {
  ...
  "sideMenu.googleDriveSync": "Google Drive sync",
  "sideMenu.googleDriveUnavailable": "Google Drive sync unavailable",
  "sideMenu.googleDriveLogin": "Sign in to Google Drive",
  "sideMenu.googleDriveCaption": "Sync all bars, ingredients, cocktails and settings",
  "sideMenu.googleDriveSyncNow": "Sync with Google Drive",
  "sideMenu.googleDriveConnectedAs": "Connected: {{email}}",
  "sideMenu.googleDriveUnknownAccount": "Google account",
  "sideMenu.googleDriveLogout": "Sign out from Google Drive",
  "sideMenu.googleDriveLogoutCaption": "Disconnect cloud sync for this device",
  "sideMenu.googleDriveConnectedTitle": "Google Drive connected",
  ...
  "sideMenu.googleDriveAuthCancelledHint": "Google sign-in was dismissed before callback. Rebuild the app after OAuth config changes and try again.",
  "sideMenu.googleDriveLoginFailed": "Unable to sign in. Please try again.",
  "sideMenu.googleDriveSyncSuccessTitle": "Sync complete",
  "sideMenu.googleDriveSyncSuccessMessage": "Your inventory and settings are synced to Google Drive.",
  "sideMenu.googleDriveSyncFailed": "Sync failed. Please try again later.",
