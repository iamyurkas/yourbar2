...
export const esESTranslations: TranslationDictionary = {
  ...
  "sideMenu.googleSignIn": "Iniciar sesión con Google",
  "sideMenu.googleSignInCaption": "Sincroniza tus datos entre dispositivos",
  "sideMenu.googleSync": "Sincronizar con Google Drive",
  "sideMenu.syncing": "Sincronizando...",
  "sideMenu.googleSigningIn": "Iniciando sesión...",
  "sideMenu.syncError": "Falló la sincronización. Toca para reintentar.",
  "sideMenu.lastSync": "Última sincronización: {{time}}",
  "sideMenu.googleSignOutTitle": "Cerrar sesión",
  "sideMenu.googleSignOutMessage": "¿Seguro que quieres cerrar sesión en Google?",
  "sideMenu.signOut": "Cerrar sesión",
