...
export const esESTranslations: TranslationDictionary = {
  ...
  "sideMenu.manageBars": "Bares",
  "sideMenu.manageBarsCaption": "Activo: {{name}}",
  "sideMenu.activeBarSelected": "Seleccionado",
  "sideMenu.tapToSelectBar": "Toca para activar",
  "sideMenu.barNamePlaceholder": "Nombre del bar",
  "sideMenu.deleteBarTitle": "Eliminar bar",
  "sideMenu.deleteBarMessage": "¿Eliminar \"{{name}}\"?",
  "sideMenu.deleteBarA11y": "Eliminar {{name}}",
