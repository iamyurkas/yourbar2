...
export const esESTranslations: TranslationDictionary = {
  ...
  "sideMenu.googleDriveSync": "Sincronización con Google Drive",
  "sideMenu.googleDriveUnavailable": "Sincronización con Google Drive no disponible",
  "sideMenu.googleDriveLogin": "Iniciar sesión en Google Drive",
  "sideMenu.googleDriveCaption": "Sincroniza todos los bares, ingredientes, cócteles y ajustes",
  "sideMenu.googleDriveSyncNow": "Sincronizar con Google Drive",
  "sideMenu.googleDriveConnectedAs": "Conectado: {{email}}",
  "sideMenu.googleDriveUnknownAccount": "Cuenta de Google",
  "sideMenu.googleDriveLogout": "Cerrar sesión de Google Drive",
  "sideMenu.googleDriveLogoutCaption": "Desconectar la sincronización en la nube en este dispositivo",
  "sideMenu.googleDriveConnectedTitle": "Google Drive conectado",
  ...
  "sideMenu.googleDriveAuthCancelledHint": "El inicio de sesión de Google se cerró antes del callback. Vuelve a generar la app tras cambios OAuth e inténtalo de nuevo.",
  ...
  "sideMenu.googleDriveSyncFailed": "Error de sincronización. Inténtalo más tarde.",
