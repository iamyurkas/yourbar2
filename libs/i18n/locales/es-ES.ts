...
export const esESTranslations: TranslationDictionary = {
  ...
  "sideMenu.favoritesRatingFilterCaption": "Mostrando cócteles de {{rating}}+ estrellas",
  ...
  "sideMenu.amazonStore": "Tienda Amazon",
  ...
  "sideMenu.setThemeA11y": "Configurar tema {{theme}}",
