...
export const ukUATranslations: TranslationDictionary = {
  ...
  "sideMenu.manageBars": "Бари",
  "sideMenu.manageBarsCaption": "Активний: {{name}}",
  "sideMenu.activeBarSelected": "Обрано",
  "sideMenu.tapToSelectBar": "Натисніть, щоб зробити активним",
  "sideMenu.barNamePlaceholder": "Назва бару",
  "sideMenu.deleteBarTitle": "Видалити бар",
  "sideMenu.deleteBarMessage": "Видалити \"{{name}}\"?",
  "sideMenu.deleteBarA11y": "Видалити {{name}}",
