...
export const ukUATranslations: TranslationDictionary = {
  ...
  "sideMenu.googleDriveConnected": "Google Drive підключено",
  "sideMenu.googleDriveLoggingIn": "Вхід у Google Drive...",
  "sideMenu.googleDriveDisconnectedCaption": "Натисніть, щоб увійти та увімкнути хмарну синхронізацію",
  "sideMenu.googleDriveSyncUpload": "Вивантажити резерв у хмару",
  "sideMenu.googleDriveSyncUploading": "Вивантаження резерву у хмару...",
  "sideMenu.googleDriveSyncUploadCaption": "Синхронізувати бари, інгредієнти, коктейлі та налаштування у Google Drive",
  "sideMenu.googleDriveSyncDownload": "Завантажити резерв із хмари",
  ...
  "sideMenu.googleDriveSyncUploadSuccessMessage": "Останній резерв завантажено в Google Drive.",
  "sideMenu.googleDriveSyncDownloadSuccessMessage": "Ваш бар відновлено з Google Drive.",
  "sideMenu.googleDriveSyncFailedTitle": "Помилка синхронізації з Google Drive",
  "sideMenu.googleDriveSyncFailedMessage": "Не вдалося синхронізуватися з Google Drive. Спробуйте ще раз.",
  "sideMenu.googleDriveNoBackupTitle": "Резерв у Google Drive не знайдено",
  "sideMenu.googleDriveNoBackupMessage": "У даних застосунку Google Drive немає резерву {{file}}.",
