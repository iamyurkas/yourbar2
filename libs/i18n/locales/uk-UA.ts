...
export const ukUATranslations: TranslationDictionary = {
  ...
  "sideMenu.favoritesRatingFilterModalCaption": "Оберіть мінімальний рейтинг для показу в Обраних",
  ...
  "sideMenu.startingScreenCaption": "Оберіть, з якого екрана відкривати застосунок",
  "sideMenu.amazonStoreCaption": "Перевизначте автоматичне визначення, щоб вибрати бажаний магазин Amazon.",
  "sideMenu.automatic": "Автоматично",
  "sideMenu.detectedAmazonStore": "Визначено: {{label}}",
  "tagEditor.editTag": "Редагувати тег",
  "sideMenu.restore": "Відновити",
  "sideMenu.restoreBundledDataTitle": "Відновити вбудовані дані",
  "sideMenu.restoreBundledDataMessage": "Це відновить вбудовані коктейлі та інгредієнти.\nВаші власні коктейлі та інгредієнти залишаться без змін.",
  "sideMenu.restoreBundledDataCaption": "Вбудовані зміни буде втрачено, ваш власний контент залишиться",
  ...
  "sideMenu.backupUnavailableMessage": "Завантажте інвентар перед резервним копіюванням.",
  "sideMenu.sharingUnavailableTitle": "Поширення недоступне",
  "sideMenu.sharingUnavailableMessage": "На цьому пристрої недоступна функція поширення.",
  "sideMenu.exportFailedTitle": "Помилка експорту",
  "sideMenu.exportFailedStorageMessage": "Не вдалося отримати доступ до сховища пристрою.",
  "sideMenu.backupFailedTitle": "Помилка резервного копіювання",
  "sideMenu.importFailedTitle": "Помилка імпорту",
  "sideMenu.importFailedReadMessage": "Не вдалося прочитати вибраний архів.",
  "sideMenu.importFailedEmptyMessage": "Вибраний архів порожній.",
  "sideMenu.importFailedMissingInventoryMessage": "У резервному архіві відсутні дані інвентарю.",
  "sideMenu.importFailedInvalidInventoryMessage": "Резервний архів містить некоректні дані інвентарю.",
  "sideMenu.importFailedStorageMessage": "Не вдалося отримати доступ до сховища пристрою.",
  "sideMenu.importFailedTryValidArchiveMessage": "Спробуйте ще раз із коректним резервним архівом.",
  "sideMenu.deleteTagTitle": "Видалити тег",
  "sideMenu.deleteTagMessage": "Видалити \"{{name}}\"?",
  "sideMenu.showStarsAndUp": "Показати від {{value}} зірки й вище",
  "sideMenu.editTagAccessibility": "Редагувати {{name}}",
  ...
  "sideMenu.restoringData": "Відновлюємо дані...",
  "sideMenu.restoreDataCaption": "Імпортувати коктейлі, інгредієнти та фото з архіву",
