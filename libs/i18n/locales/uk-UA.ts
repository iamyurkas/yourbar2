...
export const ukUATranslations: TranslationDictionary = {
  ...
  "ingredientForm.cropCurrentPhoto": "Обрізати поточне фото",
  "ingredientForm.cropPhotoTitle": "Обрізка фото інгредієнта",
  "ingredientForm.couldNotCropImage": "Не вдалося обрізати зображення",
  ...
  "cocktailForm.cropCurrentPhoto": "Обрізати поточне фото",
  "cocktailForm.cropPhotoTitle": "Обрізка фото коктейлю",
  "cocktailForm.couldNotCropImage": "Не вдалося обрізати зображення",
