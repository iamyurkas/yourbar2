...
export const ukUATranslations: TranslationDictionary = {
  ...
  "sideMenu.startScreenModalDescription": "Оберіть, з якого екрана відкривати застосунок",
  "sideMenu.startScreenOptionA11y": "Відкривати спочатку {{screen}}",
  "sideMenu.amazonStoreModalDescription": "Перевизначте автоматичне визначення, щоб вибрати бажаний магазин Amazon.",
  ...
  "sideMenu.restoreBundledDataDescription": "Вбудовані зміни буде скасовано, ваш власний контент залишиться",
  "sideMenu.restoreBundledDataConfirmMessage": "Це відновить вбудовані коктейлі та інгредієнти.\nВаші власні коктейлі та інгредієнти залишаться без змін.",
  ...
  "sideMenu.backupUnavailableMessage": "Завантажте інвентар перед створенням резервної копії.",
  "sideMenu.sharingUnavailableTitle": "Поширення недоступне",
  "sideMenu.sharingUnavailableMessage": "Поширення недоступне на цьому пристрої.",
  ...
  "sideMenu.deviceStorageUnavailable": "Не вдалося отримати доступ до сховища пристрою.",
  "sideMenu.importReadArchiveFailed": "Не вдалося прочитати вибраний архів.",
  "sideMenu.importArchiveEmpty": "Вибраний архів порожній.",
  "sideMenu.importMissingInventory": "В архіві резервної копії відсутні дані інвентарю.",
  "sideMenu.importInvalidInventory": "Архів резервної копії містить некоректні дані інвентарю.",
  "sideMenu.importRetryWithValidArchive": "Спробуйте ще раз із коректним архівом резервної копії.",
  ...
  "sideMenu.emailUnavailableMessage": "Надішліть звіт вручну на your.bar.app@gmail.com.",
  "sideMenu.favoritesRatingModalDescription": "Оберіть мінімальний рейтинг для вкладки обраного",
  "sideMenu.favoritesRatingOption": "Показувати від {{value}} зірок",
  "sideMenu.useAutomaticAmazonStoreDetection": "Використовувати автоматичне визначення магазину Amazon",
  ...
  "sideMenu.backupDataDescription": "Експортувати коктейлі, інгредієнти та фото в один архів",
  "sideMenu.restoreData": "Відновити дані",
  "sideMenu.restoringData": "Відновлення даних...",
  "sideMenu.restoreDataDescription": "Імпортувати коктейлі, інгредієнти та фото з архіву",
  ...
  "glassware.hurricane_glass": "Харрікейн",
  "glassware.toddy_glass": "Келих для Тодді",
  "glassware.margarita_glass": "Келих для Маргарити",
  "glassware.nick_and_nora": "Нік енд Нора",
  "glassware.pitcher": "Глечик",
  "glassware.pub_glass": "Пивний келих",
  "glassware.rocks_glass": "Рокс",
  "glassware.shooter": "Шутер",
  "glassware.snifter": "Сніфтер",
  "glassware.tiki_glass": "Тікі-келих",
  "glassware.wine_glass": "Келих для вина",

  "unit.1.singular": " ",
  "unit.1.plural": " ",
  "unit.2.one": "барна ложка",
  "unit.2.few": "барні ложки",
  "unit.2.many": "барних ложок",
  "unit.2.other": "барної ложки",
  "unit.3.singular": "кл",
  "unit.3.plural": "кл",
  "unit.4.one": "кубик",
  "unit.4.few": "кубики",
  ...
  "unit.9.other": "половинки",
  "unit.10.one": "листок",
  "unit.10.few": "листки",
  "unit.10.many": "листків",
  "unit.10.other": "листка",
  "unit.11.singular": "мл",
  "unit.11.plural": "мл",
  "unit.12.one": "унція",
  "unit.12.few": "унції",
  ...
  "unit.13.few": "частини",
  "unit.13.many": "частин",
  "unit.13.other": "частини",
  "unit.14.one": "спіраль цедри",
  "unit.14.few": "спіралі цедри",
  "unit.14.many": "спіралей цедри",
  "unit.14.other": "спіралі цедри",
  "unit.15.one": "дрібка",
  "unit.15.few": "дрібки",
  "unit.15.many": "дрібок",
  "unit.15.other": "дрібки",
  "unit.16.one": "чверть",
  "unit.16.few": "чверті",
  "unit.16.many": "чвертей",
  "unit.16.other": "чверті",
  "unit.17.one": "черпак",
  "unit.17.few": "черпаки",
  "unit.17.many": "черпаків",
  "unit.17.other": "черпака",
  "unit.18.one": "стружка",
  "unit.18.few": "стружки",
  "unit.18.many": "стружок",
  "unit.18.other": "стружки",
  "unit.19.one": "скибка",
  "unit.19.few": "скибки",
  "unit.19.many": "скибок",
  "unit.19.other": "скибки",
  "unit.20.one": "сплеск",
  "unit.20.few": "сплески",
  "unit.20.many": "сплесків",
  "unit.20.other": "сплеску",
  "unit.21.one": "гілочка",
  "unit.21.few": "гілочки",
  "unit.21.many": "гілочок",
  "unit.21.other": "гілочки",
  "unit.22.one": "стебло",
  "unit.22.few": "стебла",
  "unit.22.many": "стебел",
  "unit.22.other": "стебла",
  "unit.23.one": "столова ложка",
  "unit.23.few": "столові ложки",
  "unit.23.many": "столових ложок",
  "unit.23.other": "столової ложки",
  "unit.24.one": "чайна ложка",
  "unit.24.few": "чайні ложки",
  "unit.24.many": "чайних ложок",
  "unit.24.other": "чайної ложки",
  "unit.25.one": "третина",
  "unit.25.few": "третини",
  "unit.25.many": "третин",
  "unit.25.other": "третини",
  "unit.26.one": "твіст",
  "unit.26.few": "твісти",
  "unit.26.many": "твістів",
  "unit.26.other": "твісту",
  "unit.27.one": "часточка",
  "unit.27.few": "часточки",
  "unit.27.many": "часточок",
  "unit.27.other": "часточки",
  ...
  "ingredientTag.8": "Холодильник/Комора",
