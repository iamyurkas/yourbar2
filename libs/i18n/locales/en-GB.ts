...
export const enGBTranslations: TranslationDictionary = {
  ...
  "sideMenu.manageBars": "Bars",
  "sideMenu.manageBarsCaption": "Active: {{name}}",
  "sideMenu.activeBarSelected": "Selected",
  "sideMenu.tapToSelectBar": "Tap to set active",
  "sideMenu.barNamePlaceholder": "Bar name",
  "sideMenu.deleteBarTitle": "Delete bar",
  "sideMenu.deleteBarMessage": "Delete \"{{name}}\"?",
  "sideMenu.deleteBarA11y": "Delete {{name}}",
