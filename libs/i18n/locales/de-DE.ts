...
export const deDETranslations: TranslationDictionary = {
  ...
  "sideMenu.googleSignIn": "Mit Google anmelden",
  "sideMenu.googleSignInCaption": "Daten geräteübergreifend synchronisieren",
  "sideMenu.googleSync": "Mit Google Drive synchronisieren",
  "sideMenu.syncing": "Synchronisierung...",
  "sideMenu.googleSigningIn": "Anmeldung läuft...",
  "sideMenu.syncError": "Synchronisierung fehlgeschlagen. Tippen zum Wiederholen.",
  "sideMenu.lastSync": "Letzte Synchronisierung: {{time}}",
  "sideMenu.googleSignOutTitle": "Von Google abmelden",
  "sideMenu.googleSignOutMessage": "Möchten Sie sich wirklich von Google abmelden?",
  "sideMenu.signOut": "Abmelden",
