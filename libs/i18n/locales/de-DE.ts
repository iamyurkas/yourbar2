...
export const deDETranslations: TranslationDictionary = {
  ...
  "cocktailDetails.exportSuccessTitle": "Cocktail exportiert",
  "cocktailDetails.exportSuccessMessage": "Bild gespeichert unter: {{path}}",
  "cocktailDetails.exportFailedTitle": "Export fehlgeschlagen",
  "cocktailDetails.exportPermissionTitle": "Medienzugriff erforderlich",
  "cocktailDetails.exportPermissionMessage":
    "Erlauben Sie den Medienzugriff in den Systemeinstellungen, um diesen Cocktail als Bild zu exportieren.",
