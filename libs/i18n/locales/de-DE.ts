...
export const deDETranslations: TranslationDictionary = {
  ...
  "sideMenu.googleDriveSync": "Google-Drive-Synchronisierung",
  "sideMenu.googleDriveUnavailable": "Google-Drive-Synchronisierung nicht verfügbar",
  "sideMenu.googleDriveLogin": "Bei Google Drive anmelden",
  "sideMenu.googleDriveCaption": "Alle Bars, Zutaten, Cocktails und Einstellungen synchronisieren",
  "sideMenu.googleDriveSyncNow": "Mit Google Drive synchronisieren",
  "sideMenu.googleDriveConnectedAs": "Verbunden: {{email}}",
  "sideMenu.googleDriveUnknownAccount": "Google-Konto",
  "sideMenu.googleDriveLogout": "Von Google Drive abmelden",
  "sideMenu.googleDriveLogoutCaption": "Cloud-Synchronisierung auf diesem Gerät trennen",
  "sideMenu.googleDriveConnectedTitle": "Google Drive verbunden",
  ...
  "sideMenu.googleDriveSyncFailed": "Synchronisierung fehlgeschlagen. Bitte später erneut versuchen.",
